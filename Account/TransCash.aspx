<%@ Page Title="انتقال وجه" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="TransCash.aspx.cs" Inherits="Account_TransCash" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph" runat="Server">
        ...
        <ContentTemplate>
            <asp:Panel ID="Panel1" runat="server" DefaultButton="btnCheck">
                <table style="margin: 5px 70px 0 0;">
                    <tr>
                        <td class="fieldName">شماره حساب برداشتی :
                        </td>
                        <td>
                            <asp:TextBox ID="txtFromAccountNo" runat="server" CssClass="textbox" MaxLength="15"
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="شماره حساب را وارد نمایید"
                                ControlToValidate="txtFromAccountNo" CssClass="validator"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtToAccountNo" runat="server" CssClass="textbox" MaxLength="15"
                                Style="direction: ltr;" onkeypress="javascript:return isNumberKey(event)" />
                        </td>
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="شماره حساب را وارد نمایید"
                                ControlToValidate="txtToAccountNo" CssClass="validator"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="fieldName">مبلغ (ریال) :
                        </td>
                        <td>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <img id="imgcaptcha" src="../Captcha.ashx?mode=3" alt="کد امنیتی" />
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btnCheck" runat="server" CssClass="button" Text="تایید" OnClick="btnCheck_Click" OnClientClick="javascript:return prePay();" />
                        </td>
                        <td>
            ...
            <asp:Panel ID="pnlConfirm" runat="server" Visible="False" DefaultButton="btnConfirm">
                        ...
                        <td valign="top">
                            <table class="account-info" style="width: 250px;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblFromAccountType" runat="server" ForeColor="#d5665d" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblFromAccountOwner" runat="server" ForeColor="#d5665d" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="fieldName">مبلغ (ریال) :
                        ...
                        <td valign="top">
                            <table class="account-info" style="width: 250px;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblToAccountType" runat="server" ForeColor="#d5665d" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="fieldName">دارنده حساب :
                                    ...
                                    <td>
                                        <asp:Label ID="lblToAccountOwner" runat="server" ForeColor="#d5665d" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <div style="margin-right: 70px; padding: 5px 0; width: 200px;">
                    <asp:Button ID="btnConfirm" runat="server" CssClass="button" Text="تایید و انتقال وجه"
                        OnClick="btnConfirm_Click" Width="110px" CausesValidation="false" />
                </div>
            </asp:Panel>
    ...
    <script type="text/javascript">
        ...
        function prePay() {
            ...
            $get('<%=hdnAmount.ClientID %>').value = amount.trim();
        ...
        $(window).unload(function () {
            $('#imgcaptcha').attr('src', '../Captcha.ashx?cls=3');
        });

        function loadCaptcha() {
            $get('<%=txtAnswer.ClientID %>').value = '';
            $('#imgcaptcha').attr('src', '../Captcha.ashx?mode=3&ci=' + reqIndex++);
        }
